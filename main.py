...
def _silent_popen(*args, **kwargs):
    if kwargs.get('shell') and 'creationflags' not in kwargs:
...
TOOL_DECLARATIONS = [
    {
        ...
        "description": (
            ...
            "Always call this tool â€” never just say you opened it."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
...
class JarvisLive:
    ...
    async def _h_switch_persona(self, args, loop, _run):
        ...
        if new_persona == "agata":
            ...
            return "Hola, seÃ±or. Soy Agata. Encantada de estar con usted. Â¿En quÃ© puedo ayudarle hoy?"
        else:
            self.ui.write_log("SYS: JARVIS reactivado.")
            return "SeÃ±or, Jarvis de vuelta. Â¿CÃ³mo estÃ¡? AquÃ­ estoy para lo que necesite."
